========================================================================
    APPLICAZIONE CONSOLE: cenni preliminari sul progetto SimpleBoostThreading
========================================================================

La creazione guidata applicazione ha creato questa applicazione SimpleBoostThreading.

Questo file contiene un riepilogo del contenuto di ciascun file che fa parte
dell'applicazione SimpleBoostThreading.


SimpleBoostThreading.vcxproj
...
SimpleBoostThreading.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Tali file vengono utilizzati per generare il file di intestazione precompilato SimpleBoostThreading.pch e il file dei tipi precompilato StdAfx.obj.
